...
export class Trios implements OnInit {
  ...
  private initializeTrios() {
    ...
    const trioDefinitions = [
      ...
      {
        name: "Anime Little Sister Trio",
        description: "Moe characters who love their onii-chan",
        characterShortNames: ["Momo", "Mimi", "Maribelle"]
      },
      {
        name: "Loli Maid Trio",
      ...
      },
      {
        ...
        characterShortNames: ["Reina", "Maddie", "Nita"]
      },
      {
        name: "-chan Trio",
